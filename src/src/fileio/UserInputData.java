...
public final class UserInputData {
    ...
    private ArrayList<String> titlesRated;

    private Map<String, ArrayList<Integer>> serialsRated;
    ...
    public UserInputData(final String username, final String subscriptionType,
        ...
        this.titlesRated = new ArrayList<String>();
        this.serialsRated = new HashMap<>();
    }
